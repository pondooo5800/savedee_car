import SectionHeaderNewArrival from '@components/common/section-header-new-arrival';
...
const ProductsNewArrivalBlock: React.FC<ProductsProps> = ({
  sectionHeading = 'รถเข้ามาใหม่',
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center justify-between mb-5 md:mb-6">
        <SectionHeaderNewArrival sectionHeading={sectionHeading} className="mb-0" />
      </div>
      {error ? (
...
export default ProductsNewArrivalBlock;
