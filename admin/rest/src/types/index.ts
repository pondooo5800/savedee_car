...
export interface ProvinceQueryOptions extends QueryOptions {
  name: string;
  parent: number | null;
}
...
export interface ColorQueryOptions extends QueryOptions {
  name: string;
}
export interface YearQueryOptions extends QueryOptions {
  name: string;
}
export interface GearQueryOptions extends QueryOptions {
  name: string;
}
export interface CreditQueryOptions extends QueryOptions {
  name: string;
}
...
export interface ColorPaginator extends PaginatorInfo<Model> {}

export interface YearPaginator extends PaginatorInfo<Model> {}

export interface GearPaginator extends PaginatorInfo<Model> {}

export interface CreditPaginator extends PaginatorInfo<Model> {}
