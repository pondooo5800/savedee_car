...
const ShopForm = ({ initialValues }: { initialValues?: any }) => {
  ...
  const coverImageInformation = (
    <span>
      อัปโหลดภาพหน้าปกร้านค้าของคุณจากที่นี่ <br />
      ขนาดภาพปกควรเป็น &nbsp;
    ...
    <>
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
        <div className="my-5 flex flex-wrap border-b border-dashed border-border-base pb-8 sm:my-8">
          <Description
            title="โลโก้"
            details="อัปโหลดโลโก้ร้านค้าของคุณจากที่นี่"
        ...
        <div className="my-5 flex flex-wrap border-b border-dashed border-border-base pb-8 sm:my-8">
          <Description
            title="ข้อมูลพื้นฐาน"
            details="เพิ่มข้อมูลพื้นฐานเกี่ยวกับร้านของคุณจากที่นี่"
            className="w-full px-0 pb-5 sm:w-4/12 sm:py-8 sm:pe-4 md:w-1/3 md:pe-5"
          />
          <Card className="w-full sm:w-8/12 md:w-2/3">
            <Input
        ...
        <div className="my-5 flex flex-wrap border-b border-dashed border-gray-300 pb-8 sm:my-8">
          <Description
            title="ที่อยู่"
            details="เพิ่มที่อยู่ร้านของคุณจากที่นี่"
            className="w-full px-0 pb-5 sm:w-4/12 sm:py-8 sm:pe-4 md:w-1/3 md:pe-5"
          />
        ...
        <div className="my-5 flex flex-wrap border-b border-dashed border-gray-300 pb-8 sm:my-8">
          <Description
            ...
            details="เพิ่มข้อมูลการตั้งค่าร้านของคุณจากที่นี่"
            className="w-full px-0 pb-5 sm:w-4/12 sm:py-8 sm:pe-4 md:w-1/3 md:pe-5"
          />

          <Card className="w-full sm:w-8/12 md:w-2/3">
            <div className="mb-5">
              <Label>กำหนดตำแหน่งจากแผนที่</Label>
              <Controller
                control={control}
                  ...
                  >
                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-5">
                      <div className="sm:col-span-2">
                        <Label>เลือกแพลตฟอร์มโซเชียล</Label>
                        <SelectInput
