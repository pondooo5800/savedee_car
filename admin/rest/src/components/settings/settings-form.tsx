...
export default function SettingsForm({
  ...
  const logoInformation = (
    <span>
      อัปโหลดโลโก้ไซต์ของคุณจากที่นี่ <br />
      ขนาดโลโก้ควรจะเป็น &nbsp;
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="flex flex-wrap pb-8 my-5 border-b border-dashed border-border-base sm:my-8">
        <Description
          title="ข้อมูล"
          details="เปลี่ยนข้อมูลไซต์ของคุณจากที่นี่"
          className="w-full px-0 pb-5 sm:w-4/12 sm:py-8 sm:pe-4 md:w-1/3 md:pe-5"
        />
      ...
      <div className="flex flex-wrap pb-8 my-5 border-b border-dashed border-border-base sm:my-8">
        <Description
          title="SEO"
          details="เปลี่ยน SEO ไซต์ของคุณจากที่นี่"
      ...
      <div className="flex flex-wrap my-5 sm:my-8 hidden">
        <Description
      ...
      <div className="flex flex-wrap pb-8 my-5 border-b border-gray-300 border-dashed sm:my-8">
        <Description
          title="ตั้งค่า"
          details="เพิ่มข้อมูลการตั้งค่าของคุณจากที่นี่"
          className="w-full px-0 pb-5 sm:w-4/12 sm:py-8 sm:pe-4 md:w-1/3 md:pe-5"
        />
